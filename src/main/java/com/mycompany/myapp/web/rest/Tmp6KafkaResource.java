...
@RestController
@RequestMapping("/api/tmp-6-kafka")
public class Tmp6KafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(Tmp6KafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public Tmp6KafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
